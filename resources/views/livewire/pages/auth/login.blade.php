    ...
    <form wire:submit="login">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm text-indigo-400 hover:text-indigo-300 transition-colors duration-200" href="{{ route('password.request') }}" wire:navigate>
                    Forgot password?
                </a>
            @endif
        </div>
        ...
        <p class="mt-6 text-center text-sm text-slate-400">
            ...
            <a href="{{ route('register') }}" wire:navigate class="text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-200">Create one</a>
        </p>
    </form>
</div>
